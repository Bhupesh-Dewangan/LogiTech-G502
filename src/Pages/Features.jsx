    ...
    return (
        <div id="features" className=' w-full bg-black text-white flex flex-col items-center justify-start pb-20 px-6 lg:px-20'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-6 mx-auto mb-10 w-full max-w-6xl mt-10'>
                {/* Pair 1 */}
                <img src={BottomMouseImg} alt="Hero 25K Sensor" className='w-full rounded-2xl lg:order-1' />
                <div className='w-full lg:order-4 flex flex-col justify-center'>
                ...
                {/* Pair 2 */}
                <img src={Prog} alt="11 Programmable Buttons" className='w-full rounded-2xl lg:order-2' />
                <div className='w-full lg:order-5 flex flex-col justify-center'>
                ...
                {/* Pair 3 */}
                <img src={DPI} alt="On-the-Fly DPI" className='w-full rounded-2xl lg:order-3' />
                <div className='w-full lg:order-6 flex flex-col justify-center'>
